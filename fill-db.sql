...
VALUES ('Куплю гараж', 'Куплю гараж, чтобы держать там крокодила', 'OFFER', 10000, 'image1.jpg', 1),
       ...
       ('Продам крокодиловую сумку', 'Продам сумку из крокодиловой кожи, изготовление а заказ', 'SALE', 2000,
        'image5.jpg', 1);
ALTER TABLE offers
    ENABLE TRIGGER ALL;
