...
module.exports = {
  ...
  async run(args) {
    ...
    const offers = generateOffers(countOffer, titles, categories, sentences, commentsSentences);
    ...
    const categoryValues = offers.map((name) => `('${name}')`).join(`,\n`);
